...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  toggleMpvPause: () => ipcRenderer.invoke('mpv:toggle-pause'),
  setMpvPause: (paused) => ipcRenderer.invoke('mpv:set-pause', paused),
  getMpvPlaybackStatus: () => ipcRenderer.invoke('mpv:get-playback-status'),
  seekMpvPlayback: (timePos) => ipcRenderer.invoke('mpv:seek', timePos),
  setMpvVolume: (volume) => ipcRenderer.invoke('mpv:set-volume', volume),
  togglePlayerFullscreen: () => ipcRenderer.invoke('player:toggle-fullscreen'),
