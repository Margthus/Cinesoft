...
const App = () => {
  const [settings, setSettings] = useState({
    ...
    showVpnReminderBeforeTorrentDownload: false,
    warnIfNoVpnAdapterDetected: false,
    pauseTorrentOnVpnDisconnect: false,
    requireConfirmationWithoutVpn: false,
      ...
      if (window.electronAPI) {
        ...
        if (savedSettings) {
          setSettings({
            ...
            showVpnReminderBeforeTorrentDownload: savedSettings.showVpnReminderBeforeTorrentDownload === true,
            warnIfNoVpnAdapterDetected: savedSettings.warnIfNoVpnAdapterDetected === true,
            pauseTorrentOnVpnDisconnect: savedSettings.pauseTorrentOnVpnDisconnect === true,
            requireConfirmationWithoutVpn: savedSettings.requireConfirmationWithoutVpn === true,
